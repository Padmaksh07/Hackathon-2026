...
// All skills we know about for recommendations
const ALL_SKILLS = [
...
// GET all opportunities with match scores
...
// GET single opportunity detail with match
...
app.post('/api/recommendations', (req, res) => {
  ...
  // Find most in-demand missing skills across all opportunities
  const missingCount = {};
  ...
  // Near-match opportunities (score 40-79)
...
// Resume skill extraction (Gemini + keyword matching fallback)
app.post('/api/extract-skills', async (req, res) => {
  ...
  try {
    ...
    // Clean backticks or markdown if the model still returns them
